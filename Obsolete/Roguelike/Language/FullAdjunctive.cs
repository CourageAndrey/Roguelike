...
namespace Roguelike.Language
{
  ...
  public class FullAdjunctive
  {
    ...
    private FullAdjunctive(string male, string female, string none, string many, string def)
    {
      Male = male;
      Female = female;
      None = none;
    ...
    /// <param name="none">ср</param>
    /// <param name="many">мн</param>
    public FullAdjunctive(string male, string female, string none, string many)
    ...
    /// </summary>
    /// <param name="def">по умолчанию</param>
    public FullAdjunctive(string def)
